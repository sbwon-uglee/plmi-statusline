...
#
# sha256 은 이렇게 구한다.
#   curl -sL https://github.com/sbwon-uglee/plmi-statusline/archive/refs/tags/v0.4.2.tar.gz | shasum -a 256
class Plmi < Formula
  desc "Claude Code 상태줄에 사는 도트 캐릭터 플밍이"
  homepage "https://github.com/sbwon-uglee/plmi-statusline"
  url "https://github.com/sbwon-uglee/plmi-statusline/archive/refs/tags/v0.4.2.tar.gz"
