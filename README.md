...
말풍선은 일이 난 순간부터 한 글자씩 나오고, 다 나오면 잠깐 머문다. 심심해와 안 됐어는
쉬었다가 다시 말하고, 앗과 끝은 한 번만 한다. 일하는 중 문구는 떠 있는 채로 뒤에서 점만 돈다.
상자는 처음부터 다 말했을 때 크기로 잡으므로 글자가 나오는 동안 그림이 밀리지 않는다.
